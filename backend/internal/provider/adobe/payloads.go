...
var gptImageSize = map[string]map[string][2]int{
	"1K": {"1:1": {1024, 1024}, "5:4": {1280, 1024}, "9:16": {720, 1280}, "21:9": {1680, 720}, "16:9": {1280, 720}, "4:3": {1024, 768}, "3:2": {1200, 800}, "4:5": {1024, 1280}, "3:4": {768, 1024}, "2:3": {800, 1200}},
	"2K": {"1:1": {2048, 2048}, "5:4": {2560, 2048}, "9:16": {1152, 2048}, "21:9": {2520, 1080}, "16:9": {2048, 1152}, "4:3": {2048, 1536}, "3:2": {2400, 1600}, "4:5": {2048, 2560}, "3:4": {1536, 2048}, "2:3": {1600, 2400}},
	"4K": {"1:1": {4096, 4096}, "5:4": {3840, 3072}, "9:16": {2304, 4096}, "21:9": {5040, 2160}, "16:9": {4096, 2304}, "4:3": {4096, 3072}, "3:2": {3600, 2400}, "4:5": {3072, 3840}, "3:4": {3072, 4096}, "2:3": {2400, 3600}},
}
...
func buildGPTImagePayloads(spec modelSpec, prompt, ratio, resolution string, blobIDs []string) []map[string]any {
	...
	base := map[string]any{
		...
		"referenceBlobs":     []any{},
		"generationMetadata": map[string]any{"module": "text2image", "submodule": "ff-image-generate"},
		// GPT Image 2 accepts the exact target dimensions as a WxH string. Using
		// "auto" here silently collapsed every UI tier to the upstream default.
