...
func Load() (*Config, error) {
	...
	cfg := &Config{
		...
		PublicOrigin:      strings.TrimRight(envString("PUBLIC_ORIGIN", ""), "/"),
		...
		BootstrapAdminEmail:    envString("BOOTSTRAP_ADMIN_EMAIL", ""),
		BootstrapAdminPassword: envString("BOOTSTRAP_ADMIN_PASSWORD", ""),
		GenerationWorkers:      envInt("GENERATION_WORKERS", 32),
	}
	if cfg.GenerationWorkers < 1 {
		cfg.GenerationWorkers = 1
	}
	if cfg.GenerationWorkers > 128 {
		cfg.GenerationWorkers = 128
	}
